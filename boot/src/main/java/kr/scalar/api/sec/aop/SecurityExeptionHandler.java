package kr.scalar.api.sec.aop;
import kr.scalar.api.cmm.domain.Messenger;
import kr.scalar.api.sec.exception.ErrorCode;
import kr.scalar.api.sec.exception.LoginRuntimeException;
